...
export const RenderType_MessageComponent = i0.ɵcrt({ encapsulation: 0,
...
function View_MessageComponent_1(_l) {
    return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 7, 'div', [['class',
        ...
        (_l()(), i0.ɵted(-1, null, ['\n            '])), (_l()(), i0.ɵeld(2, 0, null, null, 1, 'a', [], null, [[null, 'click']], (_v, en, $event) => {
            var ad = true;
            var _co = _v.component;
            if (('click' === en)) {
                const pd_0 = (_co.onEdit() !== false);
                ad = (pd_0 && ad);
            }
            return ad;
        }, null, null)), (_l()(), i0.ɵted(-1, null, ['Edit'])),
        (_l()(), i0.ɵted(-1, null, ['\n            '])), (_l()(), i0.ɵeld(5, 0, null, null, 1, 'a', [], null, [[null, 'click']], (_v, en, $event) => {
            var ad = true;
            var _co = _v.component;
            if (('click' === en)) {
                const pd_0 = (_co.onDelete() !== false);
                ad = (pd_0 && ad);
            }
            return ad;
...
export function View_MessageComponent_0(_l) {
    return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 13, 'article', [['class',
        ...
        (_l()(), i0.ɵted(-1, null, ['\n']))], (_ck, _v) => {
        var _co = _v.component;
        const currVal_2 = _co.belongsToUser();
        _ck(_v, 11, 0, currVal_2);
    }, (_ck, _v) => {
        var _co = _v.component;
        const currVal_0 = _co.message.content;
        _ck(_v, 3, 0, currVal_0);
        const currVal_1 = _co.message.username;
...
export const MessageComponentNgFactory = i0.ɵccf('app-message', i2.MessageComponent, View_MessageComponent_Host_0, { message: 'message' }, {}, []);
